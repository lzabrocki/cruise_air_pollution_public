...
```{R, echo = TRUE}
# load matched data
data_matched <- readRDS(here::here("1.data", "2.data_for_analysis", "1.matched_data", "1.experiments_cruise", "2.experiment_exit_cruise", "matched_data_exit_cruise.RDS"))
```
...
ggsave(graph_boxplot_difference_pollutant_no2, filename = here::here("3.outputs", "1.figures", "2.experiments_cruise", "2.experiment_exit_cruise", "2.matching_results", "graph_boxplot_difference_pollutant_no2.pdf"), 
...
ggsave(graph_boxplot_difference_pollutant_o3, filename = here::here("3.outputs", "1.figures", "2.experiments_cruise", "2.experiment_exit_cruise", "2.matching_results", "graph_boxplot_difference_pollutant_o3.pdf"), 
...
ggsave(graph_boxplot_difference_pollutant_pm10, filename = here::here("3.outputs", "1.figures", "2.experiments_cruise", "2.experiment_exit_cruise", "2.matching_results", "graph_boxplot_difference_pollutant_pm10.pdf"), 
       width = 40, height = 18, units = "cm", device = cairo_pdf)
````
...
ggsave(graph_boxplot_difference_pollutant_pm25, filename = here::here("3.outputs", "1.figures", "2.experiments_cruise", "2.experiment_exit_cruise", "2.matching_results", "graph_boxplot_difference_pollutant_pm25.pdf"), 
       width = 30, height = 15, units = "cm", device = cairo_pdf)
````
...
ggsave(graph_boxplot_difference_pollutant_so2, filename = here::here("3.outputs", "1.figures", "2.experiments_cruise", "2.experiment_exit_cruise", "2.matching_results", "graph_boxplot_difference_pollutant_so2.pdf"), 
       width = 30, height = 15, units = "cm", device = cairo_pdf)
````
...
# save the graph
ggsave(graph_p_values, filename = here::here("3.outputs", "1.figures", "2.experiments_cruise", "2.experiment_exit_cruise", "2.matching_results", "graph_p_values.pdf"), 
...
ri_data_fi_final <- readRDS(here::here("1.data", "2.data_for_analysis", "1.matched_data", "1.experiments_cruise", "2.experiment_exit_cruise", "ri_data_fisherian_intervals.rds"))
...
# save the graph
ggsave(graph_fisherian_intervals, filename = here::here("3.outputs", "1.figures", "2.experiments_cruise", "2.experiment_exit_cruise", "2.matching_results", "graph_fisherian_intervals.pdf"), width = 70, height = 30, units = "cm", device = cairo_pdf)
```
...
# save the graph
ggsave(graph_ri_ci_wilcoxon, filename = here::here("3.outputs", "1.figures", "2.experiments_cruise", "2.experiment_exit_cruise", "2.matching_results", "graph_ri_ci_wilcoxon.pdf"), width = 70, height = 30, units = "cm", device = cairo_pdf)
```
...
# save the graph
ggsave(graph_missing_pollutants, filename = here::here("3.outputs", "1.figures", "2.experiments_cruise", "2.experiment_exit_cruise", "2.matching_results", "graph_missing_pollutants.pdf"), 
...
# save the graph
ggsave(graph_ri_ci_missing_concentration, filename = here::here("3.outputs", "1.figures", "2.experiments_cruise", "2.experiment_exit_cruise", "2.matching_results", "graph_ri_ci_missing_concentration.pdf"), width = 70, height = 30, units = "cm", device = cairo_pdf)
``` 
...
data_matching_regression <- readRDS(here::here("1.data", "2.data_for_analysis", "1.matched_data", "1.experiments_cruise", "2.experiment_exit_cruise", "data_matching_regression.rds")) %>%
