...
# SCRIPT REGRESSION ANALYSIS ON MATCHING DATA: ENTERING CRUISE EXPERIMENT
...
# load matched data
data_matching <- readRDS("~/Dropbox/vessel_traffic_air_pollution_project/1.hourly_analysis/1.data/2.data_for_analysis/1.matched_data/1.experiments_cruise/1.experiment_entry_cruise/matching_data.rds.RDS") %>%
...
# save results
saveRDS(
  data_matching_analysis,
  "~/Dropbox/vessel_traffic_air_pollution_project/1.hourly_analysis/1.data/2.data_for_analysis/1.matched_data/1.experiments_cruise/1.experiment_entry_cruise/data_matching_regression.rds"
)
