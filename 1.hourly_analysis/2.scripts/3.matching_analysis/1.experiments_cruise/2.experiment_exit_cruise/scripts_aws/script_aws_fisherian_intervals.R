...
# SCRIPT RANDOMIZATION INFERENCE: EXITING CRUISE EXPERIMENT

#------------------------------------------------------------

# this script computes the 95% fisherian intervals
# for the exiting cruise experiment at the hourly level

# load packages
library(tidyverse) # for data manipulation and visualization

# load matched data
data_matched <- readRDS("~/Dropbox/vessel_traffic_air_pollution_project/1.hourly_analysis/1.data/2.data_for_analysis/1.matched_data/1.experiments_cruise/2.experiment_exit_cruise/matched_data_exit_cruise.RDS") %>%
...
# save the data
saveRDS(ri_data_fi_final, "~/Dropbox/vessel_traffic_air_pollution_project/1.hourly_analysis/1.data/2.data_for_analysis/1.matched_data/1.experiments_cruise/2.experiment_exit_cruise/ri_data_fisherian_intervals.rds")
